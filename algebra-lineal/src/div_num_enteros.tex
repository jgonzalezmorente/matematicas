...
\begin{teo}[\textbf{de la división entera}]\label{div_num_enteros:teo:1}
...
\begin{prop}\label{div_num_enteros:prop:1}
    Si el subconjunto $I\subset\ZZ$ cumple
    \begin{enumerate}[label=(\arabic*)]
        \item\label{div_num_enteros:en1:it1} $a, b\in I\Rightarrow a + b\in I$
        \item\label{div_num_enteros:en1:it2} $a\in I, c\in\ZZ\Rightarrow ac\in I$
    \end{enumerate}
...
En el próximo apartado (proposición \ref{div_num_enteros:prop:2}) demostraremos que si $m=\mcm{a,b}$ y $d=\mcd{a,b}$ entonces $md=\pm ab$. Esto permite calcular $m$ si conocemos $d$. Para el cálculo de mínimo común múltiplo de más de números utilizaremos:
\begin{ejer}   
...
\begin{teo}[\textbf{de Euclides}]\label{div_num_enteros:teo:2}
